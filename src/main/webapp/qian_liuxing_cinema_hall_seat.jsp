...
<head>
    ...
    <script>
        cid = "c_2yzd0xp5";
        ci = 57;
        window.system = {"seatsPrice":{"1":{"expression":"28X1","price":"28"},"2":{"expression":"28X2","price":"56"},"3":{"expression":"28X3","price":"84"},"4":{"expression":"28X4","price":"112"},"5":{"expression":"28X5","price":"140"},"6":{"expression":"28X6","price":"168"}},"remind":"","uuid":"1A6E888B4A4B29B16FBA1299108DBE9C0D6DFFE4F46E2C5C35AAB50DBCF05D06","cinemaId":9753};
...
<div class="container" id="app" class="page-cinemas/seat" >
    ...
    <div class="main clearfix">
        <div class="hall">
            ...
            <div class="seats-block" data-cols="11" data-section-id="264" data-section-name="默认场区" data-seq-no="201804090213801">
        ...
        <div class="side">
            <div class="movie-info clearfix">
                ...
                <div class="content">
                    <p class="name text-ellipsis">红海行动</p>
                    <div class="info-item">
                        <span>类型 :</span>
            ...
            <div class="show-info">
                <div class="info-item">
                    <span>影院 :</span>
                    <span class="value text-ellipsis">江夏高德影院</span>
                </div>
                <div class="info-item">
                    <span>影厅 :</span>
                    <span class="value text-ellipsis">一号厅</span>
                </div>
                <div class="info-item">
                    <span>版本 :</span>
                ...
                <div class="info-item">
                    <span>场次 :</span>
                    <span class="value text-ellipsis screen">今天 4月9 21:30</span>
                </div>
                <div class="info-item">
                    <span>票价 :</span>
            ...
            <div class="confirm-order">
                <form class="login-form">
                    ...
                    <div class="captcha" style="display:none">
                        ...
                        <img class="captcha-pic" src="http://www.meituan.com/account/appcaptcha?uuid=1A6E888B4A4B29B16FBA1299108DBE9C0D6DFFE4F46E2C5C35AAB50DBCF05D06&captchaHash=1523274893830">
